...
def generate_tree_html(directory):
    ...
    html = [
        ...
        "<title>Data for Memory CD8 T Cell Diversity is Spatiotemporally Imprinted</title>",
        f"<style>{css}</style>",
        "</head>",
        "<body>",
        "<h1>Data for Memory CD8 T Cell Diversity is Spatiotemporally Imprinted</h1>",
        '<div class="tree">',
        "<li>",
        " <details open>",
        " <summary>/</summary>",
